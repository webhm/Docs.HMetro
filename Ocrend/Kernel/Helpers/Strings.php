...
final class Strings extends \Twig_Extension
{
    ...
    /**
     * Ofusca una expresión de texto ejemplo mx****
     *
     * @param string $str, $start = 1, $end = 1: Variables
     *
     * @return string Cadena de texto con ofuscada
     */
    public static function hiddenString(string $str, int $start = 1, int $end = 1): string
    {
        $len = strlen($str);
    ...
    public function getFunctions(): array
    {
        return array(
            ...
            new \Twig_Function('hiddenString', array($this, 'hiddenString')),
        );
    }
